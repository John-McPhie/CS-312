...
class Proj5GUI( QMainWindow ):
	...
	def __init__( self ):
		...
		self.RED_STYLE	 = "background-color: rgb(255, 220, 220);color:black;"
		self.PLAIN_STYLE = "background-color: rgb(255, 255, 255);color:black;"
		self._MAX_SEED = 1000
